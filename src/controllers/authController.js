...
console.log('DEBUG: JWT_SECRET_TOKEN is:', JWT_SECRET_TOKEN ? 'DEFINED' : 'UNDEFINED');
...
exports.register = async (req, res) => {
    try {
        ...
        console.error('AUTH_CTRL_ERROR_REGISTER', error);
...
exports.login = async (req, res) => {
    ...
    try {
        ...
        console.error('AUTH_CTRL_ERROR_LOGIN', error);
...
exports.changePassword = async (req, res) => {
    ...
    try {
        ...
        console.error('AUTH_CTRL_ERROR_CHANGE_PASSWORD', error);
        return res.status(500).json({ success: false, message: "Internal Server error!" });
    }
}